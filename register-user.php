<?php
    ...
    if (isset($_POST['regis'])){
        ...
        $q="INSERT INTO login_user VALUES('','$nama','$username','$password','$email','$noTelpon','pelanggan') ";
        mysqli_query($conn,$q);
...
<head>
    ...
    <title>Register Pelanggan Pisang Laundry</title>
